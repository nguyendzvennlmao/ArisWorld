...
public class ArisCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender s, Command c, String l, String[] a) {
        ...
        Player p = (Player) s;
        if (a.length < 2) {
            p.sendMessage(color("&#ff0812[ᴀʀɪꜱ] /aw <create|tp|delete> <name> <desert|overworld>"));
            return true;
        }
        ...
        if (act.equals("create")) {
            ...
            p.sendMessage(color("&#facc15[ᴀʀɪꜱ] ᴆᴀɴɢ xᴀ̂ʏ ᴅᴜ̛̣ɴɢ ᴛʜᴇ̂́ ɢɪᴏ̛́ɪ ᴛʜᴇᴏ ᴀ̉ɴʜ..."));
            WorldCreator cr = new WorldCreator(name);
            cr.generator(new ArisGenerator(a[2].equalsIgnoreCase("desert")));
    ...
    public List<String> onTabComplete(CommandSender s, Command c, String l, String[] a) {
        ...
        if (a.length == 3 && a[0].equalsIgnoreCase("create")) {
            return Arrays.asList("desert", "overworld").stream()
